{
    ...
    function scriptLoaded(n, i) {
        e[i].splice(e[i].indexOf(n), 1), 1 == e.main.length && (e.main.splice(e.main.indexOf("once"), 1), window.dispatchEvent(new CustomEvent(t)))
    }
    ...
    function inject(n = chrome.runtime.getURL("")) {
        function i(t, n = "base", i, o) {
            return new Promise((async (r, a) => {
                ...
                if (c.src = t, "main" === n && (c.setAttribute("data-url", i), c.setAttribute("data-id", o), c.setAttribute("id", "injector")), (t.includes("main.js") || t.includes("loader.js")) && c.setAttribute("type", "module"), e[n] && e[n].push(t), c.addEventListener("load", (function() {
                        e[n] && scriptLoaded(t, n), this.remove(), r()
                    })), c.addEventListener("error", (function() {
                        this.remove(), a()
                    })), document.documentElement) document.documentElement.appendChild(c);
                else {
        ...
        !async function(e) {
            try {
                ...
                for (let t = 0; t < s.length; t++) {
                    const n = s[t];
                    if ("string" == typeof n) await i(`${e}src/web/${s[t]}.js`, "internal");
                    else {
                        const e = n[0],
                            t = n[1];
        ...
        let a = setInterval((function() {
            if (null !== document.head) {
                ...
                for (let t in e) {
                    ...
                    i.href = n + `src/web/css/${e[t]}.css`, i.rel = "stylesheet", document.head.appendChild(i)
                }
                clearInterval(a)
            }
        }), 0)
