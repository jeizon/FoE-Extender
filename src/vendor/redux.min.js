!(function (r, t) {
  ...
  function f(r, n, u) {
    var c;
    if (
      ("function" == typeof n && "function" == typeof u) ||
      ("function" == typeof u && "function" == typeof arguments[3])
    )
      throw Error(t(0));
    if (
      ("function" == typeof n && void 0 === u && ((u = n), (n = void 0)),
      void 0 !== u)
    ) {
    ...
    return (
      v({ type: o.INIT }),
      ((c = { dispatch: v, subscribe: h, getState: b, replaceReducer: O })[e] =
        E),
      c
    );
  }
