(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).Dexie =
        t());
})(this, function () {
  "use strict";
  var g = function () {
  ...
  function r(t, n) {
    "function" == typeof n && (n = n(s(t))),
      ("undefined" == typeof Reflect ? x : Reflect.ownKeys)(n).forEach(
        function (e) {
          c(t, e, n[e]);
        }
      );
  ...
  function c(e, t, n, r) {
    a(
      ...
      t,
      u(
        n && m(n, "get") && "function" == typeof n.get
  ...
  function A(e) {
    ...
    e = (function e(t) {
      ...
      if (b(t)) {
        ...
        var o,
          a = s(t);
        for (o in ((n = a === Object.prototype ? {} : Object.create(a)),
        S && S.set(t, n),
        t))
          m(t, o) && (n[o] = e(t[o]));
      }
  ...
  function re(i, o) {
    return i === Z
      ...
      : function () {
          ...
          return (
            t && (this.onsuccess = this.onsuccess ? ne(t, this.onsuccess) : t),
            n && (this.onerror = this.onerror ? ne(n, this.onerror) : n),
            void 0 !== r ? r : e
          );
        };
  }
    ...
    return n === Z
      ...
      : function () {
          ...
          (this.onsuccess = this.onerror = null),
            ...
            e && (this.onsuccess = this.onsuccess ? ne(e, this.onsuccess) : e),
            t && (this.onerror = this.onerror ? ne(t, this.onerror) : t);
        };
  }
  function oe(i, o) {
    return i === Z
      ...
      : function (e) {
          ...
          return (
            ...
            void 0 === t ? (void 0 === e ? void 0 : e) : u(t, e)
          );
        };
  }
  function ae(e, t) {
  ...
  function je(e) {
    ...
    if (
      (F &&
        ((this._stackHolder = U()), (this._prev = null), (this._numPrev = 0)),
      "function" != typeof e)
    ) {
  ...
  function Ze() {
    return (
      !!ze.awaits &&
      (0 == --ze.awaits && (ze.id = 0), (ze.echoes = ze.awaits * le), !0)
    );
  }
  function et(e) {
    ...
    (t ? !ze.echoes || (He++ && e === Oe) : !He || (--He && e === Oe)) ||
      ...
      e !== Oe &&
        ...
        ve &&
          ...
          (r.global || e.global) &&
            (Object.defineProperty(h, "Promise", t.PromiseProp),
            (n.all = t.all),
            (n.race = t.race),
            (n.resolve = t.resolve),
            (n.reject = t.reject),
      ...
      try {
        ...
        if (
          (h.document && document.createEvent
            ? ((r = document.createEvent("Event")).initEvent(st, !0, !0),
              u(r, i))
            : h.CustomEvent && u((r = new CustomEvent(st, { detail: i })), i),
          r &&
            h.dispatchEvent &&
            (dispatchEvent(r),
  ...
  var Pt =
      ...
      try {
        return n && n.db === this.db
          ...
          : (function t(n, r, i, o) {
              if (
                n.idbdb &&
                (n._state.openComplete || Oe.letThrough || n._vip)
              ) {
                var a = n._createTransaction(r, i, n._dbSchema);
                try {
                  a.create(), (n._state.PR1398_maxLoop = 3);
                } catch (e) {
                  return e.name === Q.InvalidState &&
                    n.isOpen() &&
                    0 < --n._state.PR1398_maxLoop
              ...
              if (n._state.openComplete)
                return lt(new J.DatabaseClosed(n._state.dbOpenError));
    ...
    (Kt.prototype.where = function (o) {
      ...
      var t = n.reduce(
        ...
        t = t[1];
      return i
        ? this.where(i.name).equals(o[i.keyPath]).filter(t)
        : e
        ? this.filter(t)
        : this.where(n).equals("");
    }),
    ...
    (Kt.prototype.orderBy = function (e) {
      return new this.db.Collection(
        new this.db.WhereClause(this, b(e) ? "[" + e.join("+") + "]" : e)
      );
    }),
    ...
    (Kt.prototype.update = function (t, n) {
      if ("object" != typeof t || b(t))
        return this.where(":id").equals(t).modify(n);
      var e = k(t, this.schema.primKey.keyPath);
      if (void 0 === e)
        return lt(
          new J.InvalidArgument("Given object does not contain its primary key")
        );
      try {
        "function" != typeof n
          ? x(n).forEach(function (e) {
    ...
    (Kt.prototype.bulkAdd = function (r, e, t) {
      ...
      return this._trans("readwrite", function (e) {
        ...
        var i = r.length,
          t = t && n ? r.map(Et(t)) : r;
        return o.core
          .mutate({ trans: e, type: "add", keys: a, values: t, wantResults: u })
          .then(function (e) {
            var t = e.numFailures,
              n = e.results,
              r = e.lastResult,
            ...
            if (0 === t) return u ? n : r;
            throw new H(
              o.name + ".bulkAdd(): " + t + " of " + i + " operations failed",
              e
            );
          });
      });
    ...
    (Kt.prototype.bulkPut = function (r, e, t) {
      ...
      return this._trans("readwrite", function (e) {
        ...
        var i = r.length,
          t = t && n ? r.map(Et(t)) : r;
        return o.core
          .mutate({ trans: e, type: "put", keys: a, values: t, wantResults: u })
          .then(function (e) {
            var t = e.numFailures,
              n = e.results,
              r = e.lastResult,
            ...
            if (0 === t) return u ? n : r;
            throw new H(
              o.name + ".bulkPut(): " + t + " of " + i + " operations failed",
              e
            );
          });
      });
    ...
    (Kt.prototype.bulkDelete = function (t) {
      ...
      return this._trans("readwrite", function (e) {
        ...
        if (0 === t) return n;
        throw new H(
          r.name + ".bulkDelete(): " + t + " of " + i + " operations failed",
          e
        );
      });
    }),
  ...
  function Bt(e, o, t, n) {
    ...
    if (e.or) {
      ...
      return Promise.all([
        e.or._iterate(r, t),
        Tt(It(e, n, t), e.algorithm, r, !e.keysOnly && e.valueMapper),
      ]);
    }
  ...
  var Nt =
    ((qt.prototype._read = function (e, t) {
      var n = this._ctx;
      return n.error
        ? n.table._trans(null, lt.bind(null, n.error))
        : n.table._trans("readonly", e).then(t);
    }),
    (qt.prototype._write = function (e) {
      var t = this._ctx;
      return t.error
        ? t.table._trans(null, lt.bind(null, t.error))
      ...
      return this._read(function (e) {
        ...
        if (At(t, !0))
          return n
            .count({
              trans: e,
              query: { index: Dt(t, n.schema), range: t.range },
            })
            .then(function (e) {
          ...
          .then(function (f) {
            function h(c) {
              ...
              return v
                ...
                .then(function (e) {
                  for (
                    var n = [], t = [], r = m ? [] : null, i = [], o = 0;
                    o < l;
                    ++o
                  ) {
                    var a = e[o],
                      u = { value: A(a), primKey: f[c + o] };
                    !1 !== p.call(u, u.value, u) &&
                      (null == u.value
                        ? i.push(f[c + o])
                        : m || 0 === Rt(g(a), g(u.value))
                        ? (t.push(u.value), m && r.push(f[c + o]))
                        : (i.push(f[c + o]), n.push(u.value)));
                  }
                  var s = At(w) &&
                    w.limit === 1 / 0 &&
                    ("function" != typeof _ || _ === Ut) && {
                      index: w.index,
                      range: w.range,
                    };
                  return Promise.resolve(
                    0 < n.length &&
                      v
                        .mutate({ trans: d, type: "add", values: n })
                        .then(function (e) {
            ...
            return h(0).then(function () {
              if (0 < u.length)
                throw new G("Error modifying one or more objects", u, s, t);
              return f.length;
            });
          });
      });
      ...
      return At(i) && ((i.isPrimKey && !gt) || 3 === n.type)
        ? this._write(function (e) {
            var t = i.table.core.schema.primaryKey,
              r = n;
            return i.table.core
              .count({ trans: e, query: { index: t, range: r } })
              .then(function (n) {
                return i.table.core
                  .mutate({ trans: e, type: "deleteRange", range: r })
                  .then(function (e) {
                    var t = e.failures;
    ...
    nn =
      ...
      (rn.prototype.create = function (t) {
        ...
        return (
          ...
          ((t = this.idbtrans =
            t ||
            (this.db.core || e).transaction(this.storeNames, this.mode, {
          ...
          (t.onabort = We(function (e) {
            $t(e),
              n.active && n._reject(new J.Abort(t.error)),
              (n.active = !1),
              n.on("abort").fire(e);
          })),
          (t.oncomplete = We(function () {
            (n.active = !1),
              n._resolve(),
              "mutatedParts" in t && tn.storagemutated.fire(t.mutatedParts);
          })),
          this
        );
      }),
      (rn.prototype._promise = function (n, r, i) {
        ...
        if ("readwrite" === n && "readwrite" !== this.mode)
          return lt(new J.ReadOnly("Transaction is readonly"));
          ...
          return new Promise(function (t, e) {
            ...
            if ("deleteRange" === v) {
              ...
              if (i)
                for (var d = 0; d < a; ++d)
                  s.push(
                    (o = h && void 0 !== h[d] ? n[v](f[d], h[d]) : n[v](f[d]))
                  ),
                    (o.onerror = u);
              else
                for (d = 0; d < a; ++d)
        ...
        query:
          ...
          function (f) {
            return new Promise(function (n, e) {
              ...
              h
                ? (((c = a ? l.getAll(s, c) : l.getAllKeys(s, c)).onsuccess =
                    function (e) {
                  ...
                  (i.onsuccess = function (e) {
                    ...
                    return t
                      ? (o.push(a ? t.value : t.primaryKey),
                        ++r === u ? n({ result: o }) : void t.continue())
                      : n({ result: o });
                  }),
                  (i.onerror = Jt(e)));
            });
        ...
        openCursor: function (e) {
          ...
          return new Promise(function (t, n) {
            ...
            var e = a.index,
              ...
              s =
                !o && "openKeyCursor" in i
                  ? i.openKeyCursor(w(r), e)
                  : i.openCursor(w(r), e);
            (s.onerror = Jt(n)),
      ...
      (Oe.trans = a),
        ...
        0 === r
          ...
          : ((s = r),
                ...
                t.push(function () {
                  ...
                  if (r && u._cfg.version > s) {
                    ...
                    n = je.follow(function () {
                      ...
                      (o = r(c)) &&
                        a &&
                        ((e = Ze.bind(null, null)), o.then(e, e));
                    });
            ...
            (function e() {
              return t.length
                ? je.resolve(t.shift()(c.idbtrans)).then(e)
                : je.resolve();
            })()
              .then(function () {
                var t, n;
                (n = l),
                  x((t = h)).forEach(function (e) {
                    n.db.objectStoreNames.contains(e) ||
                      wn(n, e, t[e].primKey, t[e].indexes);
                  });
              })
              .catch(u));
    });
    ...
    for (n in t) {
      ...
      if (i) {
        ...
        if (
          ...
          (i.primKey.auto !== o.primKey.auto && !vt)
        )
          ...
          (0 < a.del.length || 0 < a.add.length || 0 < a.change.length) &&
            r.change.push(a);
        }
      } else r.add.push([n, o]);
    }
  ...
  function En(e, t, n) {
    for (
      var r = e._novip, i = n.db.objectStoreNames, o = 0;
      o < i.length;
      ++o
    ) {
      var a = i[o],
      ...
      for (var s = 0; s < u.indexNames.length; ++s) {
        ...
        !t[a] ||
          ((l = t[a].idxByName[f]) &&
            ((l.name = c), delete t[a].idxByName[f], (t[a].idxByName[c] = l)));
      }
    }
    "undefined" != typeof navigator &&
      /Safari/.test(navigator.userAgent) &&
  ...
  var Pn =
    ...
    (Kn.prototype.upgrade = function (e) {
      return (
        (this._cfg.contentUpgrade = ue(this._cfg.contentUpgrade || Z, e)), this
      );
    }),
    Kn);
  function Kn() {}
  function On(e, t) {
    ...
    return (
      n ||
        (n = e._dbNamesDB =
          new Gn(bt, { addons: [], indexedDB: e, IDBKeyRange: t }))
          .version(1)
          .stores({ dbnames: "name" }),
      n.table("dbnames")
    );
  ...
  function Cn(f) {
    ...
    F && (h.openCanceller._stackHolder = U()),
      (h.isBeingOpened = !0),
      (h.dbOpenError = null),
      (h.openComplete = !1);
    var t = h.openCanceller;
    function e() {
      if (h.openCanceller !== t)
        ...
        ("undefined" == typeof navigator
          ...
          return new je(function (s, n) {
            ...
            var c = f.name,
              l = h.autoSchema
                ? r.open(c)
                : r.open(c, Math.round(10 * f.verno));
                ...
                (d = l.transaction),
                  h.autoSchema && !f._options.allowEmptyDB
                    ? ((l.onerror = $t),
                      d.abort(),
                      l.result.close(),
                      ((t = r.deleteDatabase(c)).onsuccess = t.onerror =
                        We(function () {
                          n(
                    ...
                    : ((d.onerror = Jt(n)),
                      (e = e.oldVersion > Math.pow(2, 62) ? 0 : e.oldVersion),
                      (p = e < 1),
                      (f._novip.idbdb = l.result),
                      bn(f, e / 10, d, n));
              }, n)),
              (l.onsuccess = We(function () {
                ...
                if (0 < a.length)
                  try {
                    ...
                    h.autoSchema
                      ? ((t = o),
                        (n = u),
                        ((e = (e = f)._novip).verno = t.version / 10),
                        (n = e._dbSchema = kn(0, t, n)),
                        (e._storeNames = y(t.objectStoreNames, 0)),
                        vn(e, [e._allTables], x(n), n))
                      : (En(f, f._dbSchema, u),
                        ((i = _n(kn(0, (i = f).idbdb, u), i._dbSchema)).add
                          .length ||
                ...
                yt.push(f),
                  ...
                  p &&
                    ...
                    (o = i.indexedDB),
                    (i = i.IDBKeyRange),
                    Sn(o) || u === bt || On(o, i).put({ name: u }).catch(Z)),
                  s();
              }, n));
          });
        }),
                ...
                return Object.create(n, {
                  continue: {
                    value: function (e) {
                      null != e
                        ? n.continue(
                            Dn(e, t.reverse ? f.MAX_KEY : f.MIN_KEY, r)
                          )
                        : t.unique
                        ? n.continue(
                            n.key
                              .slice(0, i)
                              .concat(t.reverse ? f.MIN_KEY : f.MAX_KEY, r)
                          )
                        : n.continue();
                    },
                  },
              ...
              function a(c) {
                var e,
                  ...
                  f =
                    ...
                    "delete" === (n = c).type
                      ? n.keys
                      : n.keys || n.values.map(t.extractKey));
                if (!f) throw new Error("Keys missing");
                return (
                  "delete" !==
                    (c =
                      "add" === c.type || "put" === c.type
                        ? g(g({}, c), { keys: f })
                        : g({}, c)).type && (c.values = i([], c.values, !0)),
                    ...
                    var s = f.map(function (e, t) {
                      ...
                      return (
                        "delete" === c.type
                          ? h.fire.call(a, e, o, l)
                          : "add" === c.type || void 0 === o
                          ? ((n = d.fire.call(a, e, c.values[t], l)),
                            null == e &&
                              null != n &&
                              ((c.keys[t] = e = n),
                              v.outbound || E(c.values[t], v.keyPath, e)))
                          : ((n = Bn(o, c.values[t])),
  ...
  function Rn(e, t, n) {
    try {
      ...
      for (var r = [], i = 0, o = 0; i < t.keys.length && o < e.length; ++i)
        0 === Rt(t.keys[i], e[o]) &&
          (r.push(n ? A(t.values[i]) : t.values[i]), ++o);
  ...
  function qn(e, t, n) {
    ...
    if (!isNaN(r)) {
      ...
      if (Rt(n, e.from) < 0)
        return (
          i ? qn(i, t, n) : (e.l = { from: t, to: n, d: 1, l: null, r: null }),
          Wn(e)
        );
      if (0 < Rt(t, e.to))
        return (
          r ? qn(r, t, n) : (e.r = { from: t, to: n, d: 1, l: null, r: null }),
          Wn(e)
        );
      Rt(t, e.from) < 0 &&
  ...
  function Ln(e, t) {
    ...
    if (r.done) return !1;
    for (
      var i = r.value, o = Vn(e), a = o.next(i.from), u = a.value;
      !r.done && !a.done;
      ...
      next: function (e) {
        for (var t = 0 < arguments.length; n; )
          switch (n.s) {
            case 0:
              if (((n.s = 1), t))
                for (; n.n.l && Rt(e, n.n.from) < 0; )
                  n = { up: n, n: n.n.l, s: 1 };
              else for (; n.n.l; ) n = { up: n, n: n.n.l, s: 1 };
            case 1:
              if (((n.s = 2), !t || Rt(e, n.n.to) <= 0))
        ...
        table: function (d) {
          function e(e) {
            ...
            return [
              e,
              new Nn(
                null !== (e = t.lower) && void 0 !== e ? e : r.MIN_KEY,
                null !== (t = t.upper) && void 0 !== t ? t : r.MAX_KEY
              ),
            ];
          }
          var p = r.table(d),
                          ...
                          y.indexes.forEach(function (t) {
                            ...
                            (a || u).forEach(function (e, t) {
                              var n = a && r(a[t]),
                                t = u && r(u[t]);
                              0 !== Rt(n, t) &&
                                (null != n && i(n), null != t && i(t));
                            });
                          })))
                      : l
                      ? ((t = { from: l.lower, to: l.upper }),
                        s.add(t),
                        i.add(t))
                      : (i.add(m),
                        s.add(m),
  ...
  var Gn =
    ...
    (Hn.prototype._whenReady = function (e) {
      var n = this;
      return this.idbdb &&
        (this._state.openComplete || Oe.letThrough || this._vip)
        ? e()
        : new je(function (e, t) {
            if (n._state.openComplete)
              return t(new J.DatabaseClosed(n._state.dbOpenError));
            if (!n._state.isBeingOpened) {
        ...
        function e() {
          ...
          (e.onsuccess = We(function () {
            ...
            (e = i._deps),
              ...
              (n = e.indexedDB),
              (e = e.IDBKeyRange),
              Sn(n) || t === bt || On(n, e).delete(t).catch(Z),
              r();
          })),
            (e.onerror = Jt(t)),
        ...
        return je.resolve().then(function () {
          ...
          return (
            ...
            (e = je.follow(function () {
              ...
              (n = c.call(t, t)) &&
                (r
                  ? ((e = Ze.bind(null, null)), n.then(e, e))
  ...
  function Hn(e, t) {
    ...
    (c.dbReadyPromise = new je(function (e) {
      ...
      (this._state = c),
      (this.name = e),
      (this.on = Ot(this, "populate", "blocked", "versionchange", "close", {
        ready: [ue, Z],
      })),
      ...
      (this.Collection =
        ...
        St(Nt.prototype, function (e, t) {
          ...
          this._ctx = {
            ...
            isPrimKey:
              !i.index ||
              (t.schema.primKey.keyPath && i.index === t.schema.primKey.name),
            range: n,
            keysOnly: !1,
            dir: "next",
            unique: "",
  ...
  r(
    ...
    g(g({}, V), {
      ...
      waitFor: function (e, t) {
        t = je
          .resolve("function" == typeof e ? Zn.ignoreTransaction(e) : e)
          .timeout(t || 6e4);
