...
const handler = {
    ...
    setConfig: async (r, e) => chrome.storage.local.set({
        ["_cfg" + r]: e
    }, (() => {}))
};
chrome.runtime.onMessage.addListener((function(r, e, t) {
    try {
        ...
        if ("setExtConfig" === r._type) return handler.setConfig(r.id, r.cfg).then(t), !0
    } catch (r) {
        return !1
    }
})), self.arrayBufferToBase64 = function(r) {
    return r = new Uint8Array(r), btoa(Array.from(r).map((r => String.fromCharCode(r))).join(""))
